package com.example.httptest.tabmodel;
...
public class page2 extends Fragment {
    ...
    public static page2 newInstance(String param1, String param2) {
        page2 fragment = new page2(param1);
...
//        query = "FB";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        WebView mWebView = rootView.findViewById(R.id.activity_main_webview2);
//        mWebView.loadUrl("http://google.com");
        mWebView.loadUrl("file:///android_asset/indexRight.html");
